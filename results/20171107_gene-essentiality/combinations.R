...
prostate_lines = rnai[Tissue = "Prostate", Line]
...
p1 = 1/3 * sum(
    rnai[Gene == "FOXA1" & Score < rnai[Line == "22Rv1", Score], .N],
    rnai[Gene == "FOXA1" & Score < rnai[Line == "NCI-H660", Score], .N],
    rnai[Gene == "FOXA1" & Score < rnai[Line == "VCaP", Score], .N]
) / rnai[Gene == "FOXA1", .N]
print(p1)
...
medians = rnai[Description == "FOXA1" & Line %in% c("22Rv1", "NCI-H660", "VCaP"), median(Score)]
