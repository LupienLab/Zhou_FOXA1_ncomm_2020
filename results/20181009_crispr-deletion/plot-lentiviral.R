...
LNCaP <- (
    ...
    + ggtitle("FOXA1 Expression Upon Hotspot Deletion via Lentivirus")
...
#==============================================================================
#Saving the figure
ggsave("lentiviral.png", plot = LNCaP, width = 13, height = 8, dpi = 700)
ggsave("lentiviral-no-font.png", plot = LNCaP_no_font, width = 13, height = 8, dpi = 700)
